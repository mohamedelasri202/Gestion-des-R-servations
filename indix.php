...
<body class="bg-slate-50">
    <div class="min-h-screen flex">
        ...
        <aside class="w-72 ocean-gradient text-white py-8 px-6 fixed h-full">
            ...
            <nav class="space-y-6">
                <a href="#" class="flex items-center space-x-4 px-6 py-4 bg-white bg-opacity-10 rounded-xl">
        ...
        <main class="flex-1 ml-72 p-8">
            ...
            <div class="flex justify-between items-center mb-12 bg-white rounded-2xl p-6 shadow-sm">
                ...
                <div class="flex items-center space-x-6">
                    ...
                    <div class="flex items-center bg-slate-50 rounded-xl p-2 pr-4">
                        ...
                        <i class="fas fa-chevron-down ml-3 text-slate-400"></i>
                    </div>
                </div>
            </div>
                    ...
                    <table class="w-full">
                        ...
                        <tr class="hover:bg-slate-50 transition-all duration-300">
                              ...
                              <tr class="hover:bg-slate-50 transition-all duration-300">
                                <td class="px-6 py-4">
                                    <div class="flex items-center">
                                        <div class="w-10 h-10 rounded-lg bg-rose-100 flex items-center justify-center text-rose-600 font-medium mr-3">
                                            AS
                                        </div>
                                        <div>
                                            <p class="font-medium text-slate-800">Alice Smith</p>
                                            <p class="text-sm text-slate-500">alice@example.com</p>
                                        </div>
                                    </div>
                                </td>
                                <td class="px-6 py-4 text-slate-600">Scuba Diving</td>
                                <td class="px-6 py-4 text-slate-600">Dec 30, 2024</td>
                                <td class="px-6 py-4">
                            ...
                            <tr class="hover:bg-slate-50 transition-all duration-300">
                                ...
                                <td class="px-6 py-4 text-slate-600">City Tour</td>
                                <td class="px-6 py-4 text-slate-600">Dec 27, 2024</td>
                                <td class="px-6 py-4">
